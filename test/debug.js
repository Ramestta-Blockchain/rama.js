const { setProofApi, POSClient, use, Converter } = require("@ramestta/ramajs");
...
const execute = async () => {
  ...
  const l2testERC20 = pos.child.erc20;
  ...
  const l2testERC20Token = client.erc20(l2testERC20);
  const mumbaiERC20Token = client.erc20(mumbaiERC20, true);
  const mumbaiERC721Token = client.erc721(pos.parent.erc721, true);
  const l2testERC721Token = client.erc721(pos.child.erc721);
  const mumbaiERC1155Token = client.erc1155(pos.parent.erc1155, true);
  const l2testERC1155Token = client.erc1155(pos.child.erc1155);

  // setProofApi("https://proof-generator.ramestta.com");

  var result = await mumbaiERC1155Token.isWithdrawExited('0xbc48c0ccd9821141779a200586ef52033a3487c4e1419625fe7a0ea984521052', {
    returnTransaction: true
  });
  // var result = await mumbaiERC20Token.withdrawExit('0x1c20c41b9d97d1026aa456a21f13725df63edec1b1f43aacb180ebcc6340a2d3', {
  //   returnTransaction: true
  // });
  ...
  var tx = await l2testERC20Token.getAllowance(from);
  return console.log('isapp', tx);
  var tx = await mumbaiERC1155Token.deposit({
    amount: 10,
    tokenId: 123,
    userAddress: from
  }, {
  ...
  // const tx = await mumbaiERC721Token.approveAll({
  ...
  var tx = await mumbaiERC20Token.deposit(1000000000, from, {
    // returnTransaction: true
  });
  // var tx = await l2testERC20Token.transfer(10,to,{
  //   // returnTransaction: true
  // });
  // setProofApi("https://proof-generator.ramestta.com")
